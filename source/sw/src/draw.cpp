...
#define TEN_PIC 5109
    ...
    {
        tq16ang = pp->oq16ang + mulscale16(((pp->camq16ang + fix16_from_int(1024) - camerapp->oq16ang) & 0x7FFFFFF) - fix16_from_int(1024), smoothratio);
        tq16horiz = pp->oq16horiz + mulscale16(pp->camq16horiz - camerapp->oq16horiz, smoothratio);
    }
    else
    {
